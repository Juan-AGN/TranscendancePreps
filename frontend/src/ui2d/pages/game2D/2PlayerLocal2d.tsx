...
// │                    2PlayerLocal2d.tsx                      │
// ├────────────────────────────────────────────────────────────┤
// │ Local 2D game page where two players play on the same       │
// │ device.                                                    │
// └────────────────────────────────────────────────────────────┘
...
// ════════ COMPONENT: Player2vsLocal2D: Render the local 2 player game screen. ════════
export function Player2vsLocal2D() {
	...
	return (
		<ArcadeBgLayout
			...
			player2Name={t('arcade2d.hud.player2')}
			player1Score={scores.player1}
			player2Score={scores.player2}
			onBack={() => navigate('/game')}>
			{/* STEP 4: Run the 2D canvas in local Player 1 vs Player 2 mode. */}
			<Game2DCanvas
				gameMode="1v1"
				maxScore={scoreLimit}
