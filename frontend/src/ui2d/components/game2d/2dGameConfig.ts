...
//palas
export const PADDLE_WIDTH = 15				//ancho horizontal de la pala..afecta area de colision y apariencia visual
export const PADDLE_HEIGHT = 100			//altura d ela pala
export const PADDLE_SPEED = 5				// velocidad de la pala

//pelota
export const BALL_RADIUS = 10				//dibjar circulo, calcular colisiones y rebotes contra paredes
...
//Visual Tema(colores)
export const COLORS = {
	background: '#ffffff',					//color del canvas
	foreground: '#000000',					//color palas and ball
	net: '#dddddd',						//color red
	text: '#666666',						//color tesxto				
