...
// │                     ProfileButton.tsx                      │
// ├────────────────────────────────────────────────────────────┤
// │ Reusable Olympus styled button used across profile/settings│
// │ related screens.                                           │
// └────────────────────────────────────────────────────────────┘

import type { ReactNode } from "react";

type OlympusButtonProps = {
	children: ReactNode;
	onClick?: () => void;
	className?: string;
};

// ════════ COMPONENT: OlympusButton: Render a reusable styled action button. ════════
export function OlympusButton({
	...
	return (
		<button type="button"
			onClick={onClick}
			className={`group relative overflow-hidden rounded-full border border-yellow-500/60
            bg-[linear-gradient(135deg,rgba(255,255,255,0.72),rgba(255,248,220,0.38),rgba(255,255,255,0.16))]
            px-6 py-2.5 backdrop-blur-xl text-[0.72rem] font-bold uppercase tracking-[0.05rem] text-[#6b3d08] 
